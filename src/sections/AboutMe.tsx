...
const AboutMe = () => (
  <section className="max-w-[1050px] mx-auto">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-15 items-start">
      ...
      <div>
        <h2 className="text-[#1A1A1A] text-4xl font-bold py-5">About Me</h2>
        <p className="text-gray-600 text-lg leading-7.5">
        ...
        <ul className="flex flex-col gap-6 mt-10 text-black dark:text-white text-lg">
